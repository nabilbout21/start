  ...
  <div class="s006">
    <form method="post" action="moviesresults.php" id="searchsubmit">
      <div id="dontfuck" class="switchform">
        <p class="text-center" href="index.php"><img src="https://colourlex.com/wp-content/uploads/2021/02/peach-stone-black-painted-swatch.jpg" style="max-width:300px;"/></p>
        <fieldset>
